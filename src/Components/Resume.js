  ...
  render() {
    return (
      <div style={{ zIndex:'1', marginLeft: '5vw'}}>
        <a download href="/Media/Nic_Leask_Resume_3_5_20.docx" title="NicLeaskResume">
          <img className="resume" style={{ maxHeight: '80vh', marginTop: '50px', pointerEvents:'all' }} alt="NicLeaskResume" src="/Media/Nic_Leask_Resume.png"/>
        </a>
        <div style={{ color:'white', width:'100%', textAlign:'center', pointerEvents:'all'}}>Click to <a className="customLink" download href="/Media/Nic_Leask_Resume_3_5_20.docx" title="NicLeaskResume">download</a></div>
